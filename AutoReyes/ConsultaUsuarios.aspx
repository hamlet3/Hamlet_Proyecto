...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style7">
        ...
        <tr>
            <td class="auto-style5">
                <asp:Button ID="ListarUsuarios" runat="server" OnClick="ListarUsuarios_Click" Text="Buscar" />
                &nbsp;<asp:TextBox ID="BuscarNombretxt" runat="server"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
            <td class="auto-style4">
                <asp:Button ID="BuscarIdBtn" runat="server" CssClass="col-xs-offset-0" OnClick="BuscarIdBtn_Click" Text="Buscar" />
    ...
    <table class="nav-justified">
        <tr>
            ...
            <td>
                <asp:GridView ID="GVDetalle" runat="server" CssClass="auto-style8">
                </asp:GridView>
            </td>
        </tr>
        <tr>
            <td class="auto-style12">&nbsp;</td>
            <td class="auto-style13">
                <asp:Button ID="RecargarBtn" runat="server" Text="Recargar" />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>

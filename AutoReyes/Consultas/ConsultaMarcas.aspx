<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ConsultaMarcas.aspx.cs" Inherits="AutoReyes.Consultas.ConsultaMarcas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="ConsultaMarcasForm" runat="server">
        <br />
        <br />
        <br />
        <br />
            ...
            <tr>
                <td class="auto-style4">
                    <asp:DropDownList ID="FiltroDropDownList" runat="server" CssClass="form-control" Width="200px">
                        ...
                        <asp:ListItem Value="MarcaId">Id</asp:ListItem>
    ...
    <asp:TextBox ID="FiltroTextbox" runat="server" CssClass="auto-style6" Width="200px"></asp:TextBox>
            ...
            <table id="IdTable" border="1" class="auto-style10">
                ...
                <tbody>
                    <asp:ListView ID="MarcasListView" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td><%#Eval("MarcaId") %></td>
